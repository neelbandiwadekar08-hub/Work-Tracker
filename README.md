...
## 🧠 How It Was Built
This app was built using **Claude Artifacts** with a five-part prompt engineering formula:

| Part | Purpose |
|------|---------|
| **Role** | Give the AI the right lens to approach your problem |
| **Task** | Hand the AI one specific job so it never guesses |
| **Context** | Tell the AI the "why" so the output fits your real situation |
| **Data** | Feed the AI the facts it needs to build on reality |
| **Restrictions** | Draw boundaries so the output stays focused |

## 🛠️ Tech Stack
- HTML / CSS / JavaScript
- Claude Artifacts (AI-assisted development)
